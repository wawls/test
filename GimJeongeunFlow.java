...
public class GimJeongeunFlow {
    ...
    List<SwitchBlock> switchBlocks = IntStream.range(0, switchSize * 2).mapToObj(v -> dummyBlock.get()).collect(Collectors.toList());
    List<Integer> keyList = getUniqueRandomIntArray(switchSize * 2 - 1);
